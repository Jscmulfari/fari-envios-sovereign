...
const HERO_PROOF = [
  { value: "< 60 min", label: "Entrega promedio" },
  { value: "$0", label: "Primer envío" },
  { value: "24/7", label: "Soporte real" },
  { value: "3 destinos", label: "Activos hoy" },
];
      ...
      <div className="phone-frame">
        <div className="phone-statusbar">
          ...
          <div className="phone-statusbar-icons">
            <svg width="12" height="9" viewBox="0 0 12 9" fill="currentColor"><rect x="0" y="5" width="2" height="4" rx="0.5" opacity="0.4"/><rect x="2.5" y="3.5" width="2" height="5.5" rx="0.5" opacity="0.6"/><rect x="5" y="1.5" width="2" height="7.5" rx="0.5" opacity="0.8"/><rect x="7.5" y="0" width="2" height="9" rx="0.5"/></svg>
            <svg width="16" height="8" viewBox="0 0 16 8" fill="currentColor"><rect x="0" y="1" width="13" height="6" rx="1.5" stroke="currentColor" strokeWidth="0.8" fill="none" opacity="0.9"/><rect x="13.5" y="3" width="1.5" height="2" rx="0.5" opacity="0.6"/><rect x="1" y="2" width="9" height="4" rx="0.8"/></svg>
          </div>
        </div>
        ...
        <div className="phone-wa-header">
          ...
          <div className="phone-wa-info">
            ...
            <span className="phone-wa-online"><span className="phone-wa-online-dot" />En línea</span>
          </div>
            ...
            msg.type === "receipt" ? (
              ...
              <div key={i} className={`phone-msg phone-msg--${msg.from}`} style={{ "--i": i }}>
                ...
                <span className="phone-msg-meta">
                  {msg.time}
                  {msg.from === "user" && (
                    <svg width="14" height="9" viewBox="0 0 16 11" fill="none"><path d="M1 5.5L5 9.5L15 1.5" stroke="#53bdeb" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/><path d="M5 5.5L9 9.5L15 1.5" stroke="#53bdeb" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/></svg>
                  )}
                </span>
              </div>
            )
  ...
  return (
    <section id="inicio" className="ref-hero">
      ...
      <div className="ref-hero-content">
        <div className="hero-stage hero-stage--production">
          <div className="hero-live-badge">
            <span className="hero-live-dot" aria-hidden="true" />
            Servicio activo ahora
          </div>

          <div className="hero-stage-row hero-stage-row--production">
            <div className="hero-stage-main">
              <div className="hero-stage-copy">
                <h1 className="ref-hero-title">
                  Envía dinero por WhatsApp <span>con tasa clara y entrega rápida.</span>
                </h1>
                <p className="hero-stage-desc hero-stage-desc--lead">
                  Cotiza al instante, confirma el monto y continúa tu envío a Venezuela, Colombia o Europa sin bajar otra app.
                </p>
                <div className="hero-stage-ctas">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="hero-split-cta-primary"
                    aria-label="Cotizar envío por WhatsApp"
                  >
                    <WaIcon size={17} />
                    Cotizar por WhatsApp
                  </a>
                  <a href="#destinos" className="hero-split-cta-secondary">
                    Ver destinos y métodos
                  </a>
                </div>
              </div>

              <div className="hero-stage-right hero-stage-right--primary">
                <div className="hcalc hcalc--hero">
                  <div className="hcalc-topline">
                    <span className="hcalc-kicker">Calcula antes de enviar</span>
                    <span className="hcalc-chip">Respuesta inmediata</span>
                  </div>
                  ...
                  <div className="hcalc-body">
                    ...
                    <div className="hcalc-meta-row">
                      <span className="hcalc-method">{dest.flag} {dest.name} · {dest.method}</span>
                      <span className="hcalc-note">Sin comisión en tu primer envío</span>
                    </div>
                  </div>
                  ...
                  <div className="hcalc-footer">
                    <a
                      ...
                      rel="noreferrer"
                      className="hcalc-cta"
                      aria-label="Continuar envío por WhatsApp"
                    >
                      <WaIcon size={17} />
                      Continuar envío por WhatsApp
                    </a>
                    <p className="hcalc-disclaimer">Tasa referencial y confirmación final por chat.</p>
                  </div>
                </div>
              </div>
            </div>

            <aside className="hero-stage-support" aria-label="Prueba visual del proceso por WhatsApp">
              <div className="hero-stage-support-copy">
                <p className="hero-stage-support-eyebrow">Prueba del flujo</p>
                <h2>Así se ve la confirmación en chat.</h2>
                <p>
                  El mockup acompaña la cotización: primero calculas, luego confirmas por WhatsApp con soporte humano.
                </p>
              </div>
              <PhoneMockup />
            </aside>
          ...
          <div className="hero-proof-strip" aria-label="Prueba y soporte">
            {HERO_PROOF.map((item) => (
